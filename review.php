						...
						<table>
							<thead>
      							<tr class="row100 head">
         							<th class="cell100 column1">review_id</th>
      							</tr>
      						</thead>
<?php
...
?>
								...
								<tr class="row100 body">
									<td class ="cell100 column1"><?php echo $row['review_id']?></td>
								</tr>
							</tbody>
<?php
}
							...
							<table>
								<thread>
									<tr class="row100 head">
										...
										<th class="cell100 column4">user_id</th>
										<th class="cell100 column5">content</th>
										<th class="cell100 column6">review_date</th>
									</tr>
								</thread>
<?php
$sql = "SELECT * FROM review";
...
?>
		  							...
		  							<tr class="row100 body">
	          							...
	          							<td class="cell100 column4"><?php echo $row['user_id']?></td>
	          							<td class="cell100 column5"><?php echo $row['content']?></td>
	          							<td class="cell100 column6"><?php echo $row['review_date']?></td>
	      							</tr>
	      						</tbody>
<?php
}
